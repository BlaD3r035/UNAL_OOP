...
public class Resuelto_4 {
    ...
    public static void run(){
        ...
        int edad_alberto = age_calculate_alberto(edad_juan);
        int edad_ana = age_calculate_ana(edad_juan);
        int edad_mama = age_calculate_mama(edad_juan, edad_alberto, edad_ana);
        System.out.println("LAS EDADES SON: ALBERTO="+edad_alberto+", JUAN="+edad_juan+", ANA="+edad_ana+", MAMA="+edad_mama);


    }
    private static int age_calculate_alberto(int edad_juan){
        return (2 * edad_juan/3);
    }
    private static int age_calculate_ana(int edad_juan){
        return (4 * edad_juan/3);
    }
    private static int age_calculate_mama(int edad_juan, int edad_alberto, int edad_ana){
